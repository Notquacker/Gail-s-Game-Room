...
2. **Create a repository**: github.com → "+" → *New repository* →
   name it whatever you like (this one is `Gail-s-Game-Room`) → **Public** → Create
   (no README, we have files already).
...
4. **Turn on Pages**: repo page → *Settings* → *Pages* →
   ...
   `https://YOURNAME.github.io/YOUR-REPO-NAME/`  ← test it in your browser!
   (For this repo that's `https://notquacker.github.io/Gail-s-Game-Room/`.)
